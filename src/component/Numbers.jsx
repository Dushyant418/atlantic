    ...
    return (
        <section className=' position-relative bg-black -mt_1'>
            ...
            <div className="padding_top_200">
                ...
                <div className='circle_baground w-100  z-1 position-relative'>
                    <img className=' position-absolute volkswagen_position' src={Volkswagen} alt="volkswagen" />
                    <img className=' position-absolute volkswagen_position2' src={Volkswagen2} alt="volkswagen2" />
                    <img className=' position-absolute mini_position1' src={Mini} alt="mini" />
                    <img className=' position-absolute caterpillar_position' src={caterpillar} alt="caterpillar" />
                    <img className=' position-absolute mercedes_position' src={mercedes} alt="mercedes" />
                    <img className=' position-absolute mini_position2' src={Mini2} alt="mini2" />
                    <img className=' position-absolute volkswagen2_position' src={Volkswagen} alt="volkswagen" />
                </div>
